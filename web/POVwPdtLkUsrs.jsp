...
<html lang="en">
    <head>
        ...
        <title>View Product Like Users</title>
    ...
    <%
        ...
        if ((uname != null) && (upass != null)) {
            try {
                String pstID = request.getParameter("PSt_ID");
    ...
    <body>
            ...
            <header class="header black-bg">
                ...
                <div class="top-menu">
                    <ul class="nav pull-right top-menu">
                        <li><a class="logout" href="Logout.jsp?TYPE=POWNER">Logout</a></li>
                    </ul>
                </div>
            </header>
            <!--header end-->
                        ...
                        <div class="col-lg-9 main-chart" style="overflow: auto;">                           
                            <div class="row">           
                                ...
                                <%
                                    ...
                                    String pflnme = new String();
                                    String ptime = new String();
                                    String pprice = new String();
                                    String pdescs = new String();
                                    String pdid = new String();
                                    System.out.println("select * from products where ID='" + pID + "'");
                                    ResultSet rs9 = dn.Select("select * from products where ID='" + pID + "'");
                                    if (rs9.next()) {
                                        ptid = rs9.getString("ID");
                                        ptname = rs9.getString("P_Name");
                                        pflnme = rs9.getString("P_FlName");
                                        System.out.println("Files name \\\\\\\\\\\\\\\\\\\\\\\\\\\t ------------ \t" + pflnme);
                                        ptime = rs9.getString("PA_Time");
                                        pprice = rs9.getString("P_Price");
                                        pdescs = rs9.getString("P_Description");
                                        pdid = rs9.getString("Pst_ID");
                                    }
                                %>
                                <div class="col-md-10 mb" style="background: white;margin-left: 70px;height: 75%">                                 
                                    <div class="col-lg-12 col-md-4 mb">
                                        <div class="content-panel pn">
                                            <div id="blog-bg" style="background-image:url(POSTS/<%=pflnme%>);background-size: 100% 100%;"></div>
                                            <div class="blog-text">
                                                <div class="row">                                                       
                                    ...
                                    <div class="col-lg-12 col-md-4 mb">
                                        <%
                                            ResultSet rv = dn1.Select("select * from likes where Post_ID='" + pstID + "'");
                                            while (rv.next()) {
                                        %>
                                        <h3 style="color:  #0000ff;"><%=rv.getString("L_UName")%></h3><br><br>
                                        <%                                            }
                                        %>
        ...
        <%
                    ...
                    System.out.println("View LIke USers ERROR" + e);
                }
            } else {
