...
<html lang="en">
    ...
    <body>
            ...
            <header class="header black-bg">
                ...
                <div class="top-menu">
                    <ul class="nav pull-right top-menu">
                        <li><a class="logout" href="UsrBasicInfo.jsp">Add / Edit Basic Information</a></li>
                    ...
                    <div class="row" style="margin-top: 5%;">                   
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="showback">
                                ...
                                <div class="alert alert-success"><b><%=pow.getString("City")%></b></div>
        ...
        <%
                    ...
                    System.out.println("PROFILE ERROR" + e);
                }
            } else {
