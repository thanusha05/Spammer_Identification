...
<html lang="en">
    <head>
        ...
        <title>View Product Rating Of Users</title>
    ...
    <body>
                        ...
                        <div class="col-lg-9 main-chart" style="overflow: auto;">                           
                            <div class="row">           
                                ...
                                <div class="col-md-10 mb" style="background: white;margin-left: 70px;height: 75%">                                 
                                    ...
                                    <div class="col-lg-12 col-md-4 mb">
                                        <%
                                            ResultSet rv = dn1.Select("select * from rating where Post_ID='" + pstID + "'");
                                            while (rv.next()) {
                                        %>                                        
                                        <fieldset>
                                            <h3 style="color:  #0000ff;"><%=rv.getString("R_UName")%>&nbsp;&nbsp;&nbsp;----&nbsp;&nbsp;&nbsp;<%=rv.getString("Rate")%></h3>
        ...
        <%
                    ...
                    System.out.println("VIEW RATE USERS ERROR" + e);
                }
            } else {
