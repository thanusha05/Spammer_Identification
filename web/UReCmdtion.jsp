...
<html lang="en">
    <head>
        ...
        <title>User View Recommended Products</title>
    ...
    <body>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a class="active" href="UReCmdtion.jsp" >
                                <i class="fa fa-tasks"></i>
            ...
            *********************************************************************************************************************************************************** -->
                            ...
                            <div class="row">           
                                <%
                                    ...
                                    if (prm > 0) {
                                        ...
                                        for (cvb1 = 0; cvb1 < prm; cvb1++) {
                                %>
                                <div class="col-md-10 mb" style="background: white;margin-left: 70px;height: 75%">                                 
                                    <div class="col-lg-12 col-md-4 mb">
                                        <div class="content-panel pn">
                                            <div id="blog-bg" style="background-image:url(POSTS/<%=ppfname2[cvb1]%>);background-size: 100% 100%;"></div>
                                            <div class="blog-text">
                                                <div class="row">    
                                                    <%
                                                        int lcnt = clk.sinlikes(ppID[cvb1]);
                                                        int lcnts = clk.sincmmnts(ppID[cvb1]);
                                                        ResultSet rs10 = dn.Select("select * from likes where Post_ID='" + ppID[cvb1] + "' and L_UMail='" + uname + "'");
                                                        if (rs10.next()) {
                                                            if ((rs10.getString("ULORUL")).equals("Like")) {
                                                    %>
                                                    <button type="button" class="btn btn-theme" style="margin-left: 2%;" onclick="unlikefun(<%=ppID[cvb1]%>);">UnLike  | <%=lcnt%> Likes</button>                                                                                                        
                                                    <%
                                                    } else {
                                                    %>
                                                    <button type="button" class="btn btn-theme" style="margin-left: 2%;" onclick="likefun(<%=ppID[cvb1]%>);"><i class="fa fa-check"></i>Like| <%=lcnt%> Likes</button>
                                                    <%                                                 }
                                                    } else {
                                                    %>
                                                    <button type="button" class="btn btn-theme" style="margin-left: 2%;" onclick="likefun(<%=ppID[cvb1]%>);"><i class="fa fa-check"></i>Like| <%=lcnt%> Likes</button>
                                                    ...
                                                    <form class="form-inline" role="form" style="margin-top:-35px;margin-left: 145px;">
                                                        <div class="form-group">
                                                            <input class="form-control" size="35" type="hidden" name="PSTID" id="PSTID" value="<%=ppID[cvb1]%>"/>
                                                        ...
                                                        <div class="form-group">                                                            
                                                            ...
                                                            <a class="btn btn-primary" href="UViewComment.jsp?PSTID=<%=ppID[cvb1]%>"><%=lcnts%> Comments </a> 
                                                            <a class="btn btn-primary" href="URatePdt.jsp?PSTID=<%=ppID[cvb1]%>"> Rating </a> 
                                                        </div>
                                                    </form>                                                                                                    
                                                </div>
                                            </div>
                                ...
                                %>
                                <center><h3 style="color: black;">No Products In Your Circle</h3></center>
                                    <%                                    }
                                        ...
                                        String[] pstunam = new String[psts1];
                                        String[] psttime = new String[psts1];
                                        String[] psttype = new String[psts1];
            ...
            <!--<footer class="site-footer">
                <div class="text-center">                    
                    ...
                    <a href="UReCmdtion.jsp#" class="go-top">
        ...
        <%
                    ...
                    System.out.println("Recommendation ERROR " + e);
                }
            } else {
