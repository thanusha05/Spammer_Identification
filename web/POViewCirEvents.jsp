...
<html lang="en">
    <head>
        ...
        <title>Product Owner View Event Circle</title>
    ...
    <body>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a class="active" href="POViewCirEvents.jsp" >
                                <i class="fa fa-tasks"></i>
            ...
            *********************************************************************************************************************************************************** -->
                        ...
                        <div class="col-lg-9 main-chart" style="overflow: auto;">                           
                            <div class="row">           
                                ...
                                <%
                                    ...
                                    for (cvb = 0; cvb < evlnh; cvb++) {
                                        if ((etid5[cvb] != null) && (ename5[cvb] != null) && (eplace5[cvb] != null)) {
                                %>
                                <div class="col-md-10 mb" style="background: white;margin-left: 70px;height: 75%">                                 
                                    <div class="col-lg-12 col-md-4 mb">
                                        <div class="content-panel pn">
                                            <div id="blog-bg" style="background-image:url(EVENT/<%=efname5[cvb]%>);background-size: 100% 100%;"></div>
                                            <div class="blog-text">
                                                <div class="row"> 
                                                    <h4 style="color: #ff3399;"> <%=ename5[cvb]%>  ||  <%=eplace5[cvb]%>  ||   <%=edtttime5[cvb]%>  |||  Posted By <span style="color: black;"><%=epstby5[cvb]%></span></h4>                                                                                                      
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- /col-md-4-->                                                                                                                                                                       -->
            ...
            <footer class="site-footer">
                <div class="text-center">
                    ...
                    <a href="POViewCirEvents.jsp#" class="go-top">
        ...
        <%
                    ...
                    System.out.println("VIEW CIRCLE EVNTS" + e);
                }
            } else {
