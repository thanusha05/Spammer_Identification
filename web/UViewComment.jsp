            ...
            *********************************************************************************************************************************************************** -->
            ...
            <div style="overflow: auto;">                 
                <div class="col-lg-6 col-md-4 mb" style="margin-left:35%;margin-top: 10%;"> 
                    ...
                    <a class="fancybox-item fancybox-close" href="#">CLOSE</a>
                        <div id="blog-bg" style="background-image:url(POSTS/<%=flename%>);background-size: 100% 100%;"></div>
                        <div class="blog-text">
                            <div class="row">                                                       
                                <%
                                    ResultSet rs10 = dn.Select("select * from likes where Post_ID='" + pstids + "' and L_UMail='" + uname + "'");
                                    if (rs10.next()) {
                                        if ((rs10.getString("ULORUL")).equals("Like")) {
                                %>
                                <button type="button" class="btn btn-theme" style="margin-left: 2%;" onclick="unlikefun(<%=pstids%>);">UnLike  | <%=lcnt%> Likes</button>                                                                                                        
                                <%
                                } else {
                                %>
                                <button type="button" class="btn btn-theme" style="margin-left: 2%;" onclick="likefun(<%=pstids%>);"><i class="fa fa-check"></i>Like| <%=lcnt%> Likes</button>
                                <%                                                 }
                                } else {
                                %>
                                <button type="button" class="btn btn-theme" style="margin-left: 2%;" onclick="likefun(<%=pstids%>);"><i class="fa fa-check"></i>Like| <%=lcnt%> Likes</button>
            ...
            %>
            <div style="overflow: auto;">
                <div class="col-md-8 mb"style="margin-left:22%;margin-top: 10%;">
                    <a style="float: right;" href="javascript:window.history.back();"><img class="img-responsive" src="assets/img/Close_Icon.png" width="30em" height="30em" alt=""></a>
                        ...
                        <div class="content-panel pn">
                            <center>
                                <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="640" height="220" data-setup="{}">
                                    <source src="POSTS/<%=flename%>" type='video/*' />                                           
                                </video>
                                <div class="blog-text">
                                    <div class="row">    
                                        <%
                                            ...
                                            if (rs10.next()) {
                                                if ((rs10.getString("ULORUL")).equals("Like")) {
                                        %>
                                        <button type="button" class="btn btn-theme" style="margin-left: -522px;" onclick="unlikefun(<%=pstids%>);">UnLike  | <%=lcnt%> Likes</button>                                                                                                        
                                        <%
                                        } else {
                                        %>
                                        <button type="button" class="btn btn-theme" style="margin-left: -522px;" onclick="likefun(<%=pstids%>);"><i class="fa fa-check"></i>Like| <%=lcnt%> Likes</button>
                                        <%                                                 }
                                        } else {
                                        %>
                                        <button type="button" class="btn btn-theme" style="margin-left: -522px;" onclick="likefun(<%=pstids%>);"><i class="fa fa-check"></i>Like| <%=lcnt%> Likes</button>
                ...
                <div class="col-lg-6 col-md-4 mb" style="margin-left:35%;margin-top: 0%;">
                    ...
                    %>
                    <div class="showback">                   
                        <span class="badge bg-info"><%=sdt.getString("Cmnt_UName")%></span><div class="alert alert-warning"><b style=" font-size: 15px;"><%=sdt.getString("Comments")%></b></div>                    
                    </div><!-- /showback -->
                    <%               }
                    %>                                                                     
                </div>
            ...
            <%
                        ...
                        System.out.println("View COmment ERROR" + e);
                    }
                } else {
