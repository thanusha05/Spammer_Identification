...
<html lang="en">
    <head>
        ...
        <title>User View Notification</title>
    ...
    <body>
            ...
            *********************************************************************************************************************************************************** -->
                                ...
                                <div class="col-md-12">
                                    <div class="content-panel">
                                        <table class="table table-striped table-advance table-hover">
                                            <h4><i class="fa fa-angle-right"></i>View Notifications</h4>
                                            <hr>
                                            <thead>
                                                <tr>                                                    
                                                    <th style="font-size: 20px"><i class="fa fa-bookmark"></i> Notification Message</th>                                                    
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <%
                                                    ResultSet niy = dn.Select("select * from notification where D_UMail='" + uname + "'");
                                                    while (niy.next()) {
                                                %>                                                
                                                <tr>
                                                    <td><a href="#" style="font-size: 20px"><%=niy.getString("INFORMATION")%></a></td>                                                                                                                                                            
                                                </tr>   
                                                <%
                                                    }
                                                %>                                                
            ...
            <!--<footer class="site-footer">
                <div class="text-center">
                    ...
                    <a href="UNotifications.jsp#" class="go-top">
        ...
        <%
                    ...
                    System.out.println("VIEW NOTIFICATION ERROR" + e);
                }
            } else {
